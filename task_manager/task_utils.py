...
from task_manager.validation import validate_due_date, validate_task_description, validate_task_title, validate_priority
...
def view_pending_tasks(tasks):
    pending_tasks = [tasks for tasks in tasks if tasks["status"] == "pending"]
